...
1. Service account → `~/.config/rewavier/play-service-account.json` (stesso di **MusicPro Eventi**, progetto `rewavier-app`)
...
4. Play Console: invita `musicpro-play-submit@rewavier-app.iam.gserviceaccount.com` con permesso Release
